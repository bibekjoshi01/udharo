  ...
  return (
    <View style={styles.actionGrid}>
      <AppPressable style={styles.actionCard} onPress={onCustomers}>
        <Ionicons name="people-outline" size={ICON_SIZE_LG} color={COLORS.primary} style={styles.actionIcon} />
        <Text style={styles.actionLabel}>{STRINGS.customers}</Text>
      </AppPressable>

      <AppPressable style={styles.actionCard} onPress={onUdharo}>
        <Ionicons name="document-text-outline" size={ICON_SIZE_LG} color={COLORS.primary} style={styles.actionIcon} />
        <Text style={styles.actionLabel}>{STRINGS.udharoharu}</Text>
      </AppPressable>

      <AppPressable style={styles.actionCard} onPress={onBhuktani}>
        <Ionicons name="wallet-outline" size={ICON_SIZE_LG} color={COLORS.primary} style={styles.actionIcon} />
        <Text style={styles.actionLabel}>{STRINGS.bhuktaniharu}</Text>
      </AppPressable>

      <AppPressable style={styles.actionCard} onPress={onReports}>
        <Ionicons name="bar-chart-outline" size={ICON_SIZE_LG} color={COLORS.primary} style={styles.actionIcon} />
