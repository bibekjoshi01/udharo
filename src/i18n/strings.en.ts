export const STRINGS_EN = {
  ...
  // PDF
  pdfDownloadTitle: 'Download PDF',
  pdfDownloadConfirm: 'Are you sure want to download PDF?',
  download: 'Download',
  ...
  creditTableTitle: 'Credit Table',
  paymentTableTitle: 'Payment Table',
  ...
  aboutApp: 'About App',
  aboutNote:
    'This app is free to use. If you need services like data backup in the future, there may be certain charges.',
  aboutBody:
    'Udharo is a simple ledger that helps you manage customers, credits and payments. Record daily transactions quickly, see remaining balances instantly, and get a clear overview in reports.',
  ...
  exportLabel: 'Export',
  importLabel: 'Import',
  backupExportConfirm: 'Do you want to export data?',
  backupImportConfirm:
    'Importing will erase existing data. Please take a backup first. Continue?',
  backupReady: 'Backup Ready',
  backupFailed: 'Backup Failed',
  onlineBackupTitle: 'Online Backup',
  backupNotConfigured: 'Online backup is not configured.',
  phoneLoginTitle: 'Enter phone number',
  phonePlaceholder: '+977 98XXXXXXXX',
  backupContinue: 'Continue',
  phoneRequired: 'Please enter phone number.',
  loginFailed: 'Login failed',
  backupStorage: 'Storage used',
  backupStatusFree: 'Free plan (500MB)',
  backupStatusPaid: 'Paid plan',
  lastBackup: 'Last backup',
  autoBackup: 'Auto backup',
  backupNow: 'Backup now',
  backupSuccess: 'Backup completed',
  backupLimitReached: 'Backup limit reached',
  backupLimitNote: 'Free limit is 500MB. Upgrade to continue backups.',
  restoreNow: 'Restore',
  restoreConfirmTitle: 'Restore backup?',
  restoreConfirmBody: 'This will replace your current data with the backup.',
  restoreSuccess: 'Restore completed',
  restoreFailed: 'Restore failed',
  upgradeTitle: 'Upgrade',
  paymentInstruction: 'Pay Rs. 1000 via QR and enter the activation code.',
  activationCode: 'Activation code',
  redeemCode: 'Redeem',
  redeemSuccess: 'Activation successful',
  redeemFailed: 'Activation failed',
  signOut: 'Sign out',
  connectInternet: 'Connect to internet to use online backup.',
  importSuccess: 'Data Imported',
  importFailed: 'Import Failed',
  invalidFileTitle: 'Invalid File',
  invalidFileMessage: 'Please select a .sql file only.',
  ...
  copiedTitle: 'Copied',
  supportEmailSubject: 'Udharo support',
  ...
  pinRequired: 'Please enter at least 4 digits.',
  ...
  mobileLength: (len: number) => `Mobile Number must be ${len} digits.`,
